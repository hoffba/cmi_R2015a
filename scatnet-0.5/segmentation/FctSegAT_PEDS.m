function [SegLab]=FctSegAT_PEDS(Ig,ws,segn,NC,omega,beta,laaval)
...
%
%     default parameters:
%     omega=.005; For segment number estimation based on singular values
...
%     end
% end
    [C,U,LUT,H]=FastFCMeans(im2uint16(mat2gray(Ig)),dimn,4,false);

SegLab = LUT2label(im2uint16(mat2gray(Ig)),LUT);
% SegLab = Ig <= laaval + dimn;
end
