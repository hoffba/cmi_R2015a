function [imagePartitions, metaFilenames, finalCatalog] = readDicomSeries_cjg (directory, options)
...
%% Generate Catalog File (CJG 20210808)
finalCatalog = struct2table(cat(1,imagePartitions.partitionStruct));
writetable(finalCatalog,fullfile(directory,'DICOMcatalog.csv'));
...
if (options.saveCache)
    ...
    save(cacheFilename, 'imagePartitions', 'metaFilenames', 'finalCatalog');
end
