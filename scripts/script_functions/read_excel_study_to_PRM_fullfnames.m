function [ fnames, exp_mean_blood, exp_mean_air, ins_mean_blood, ins_mean_air ] = read_excel_study_to_PRM_fullfnames(  )
...
% 13 Jan 2014  JLB fixed to input
