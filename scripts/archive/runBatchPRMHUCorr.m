...
%% Set PRM options
disp('Did you remember to set the PRM options before you started?');
...
%     Cadd = Cblood - Cmult*Mblood;
    ...
    % See longitudinal matlab script for correcting using imgScale etc....
    %STARTHERE
    ...
    %Print off .mat file for each patient 
