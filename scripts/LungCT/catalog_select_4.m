...
%% Set up callbacks:
    ...
    function h = initFig
        ...
        h.panel_modules = uipanel(h.tab_opts,'Position',[5, fheight-365, 215, 260],'Title','Modules');
        ...
        h.unreg =   uicheckbox(h.panel_modules,'Position',[5,   185, 200, 20],'Text','Unreg',...
            'Value',opts.unreg,'ValueChangedFcn',@setOpts,'Tag','unreg');
        h.airway =  uicheckbox(h.panel_modules,'Position',[5,   160, 200, 20],'Text','Airways',...
            'Value',opts.airway,'ValueChangedFcn',@setOpts,'Tag','airway');
        h.scatnetAT = uicheckbox(h.panel_modules,'Position',[5,   135, 200, 20],'Text','ScatNet-AT',...
        ...
        h.panel_reg = uipanel(h.tab_opts,'Position',[225, fheight-365, 215, 260],'Title','Reg Options');
        ...
        h.panel_other = uipanel(h.tab_opts,'Position',[445, fheight-365, 215, 260],'Title','Other Options');
        ...
        h.panel_cluster = uipanel(h.tab_opts,'Position',[665, fheight-365, 215, 260],'Title','Cluster Options');
