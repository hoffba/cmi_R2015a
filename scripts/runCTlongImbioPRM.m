% CMI script
function runCTlongImbioPRM(cmiObj)
...
% 22 Sep  2013 jlb converted to cmi program launched script
% 3  Oct  2013 jlb converted to run with Imbio DICOM for ins_reg & exp_voi

% Still in DEBUG state?
disp('Caution, this script (runCTlongImbioPRM) may still be in debug state');
...
[fnames] = parse_study_to_PRM_fnamesgui();
...
% Should save all these settings to a file
...
for i = 1:length(fnames)
    ...
    % load DICOM and convert to mask
