function growMouseLungs(cmiObj,T,Tl)
...
%     slc = cmiObj.slc(3);
    ...
    if strcmp(answer,'Yes')
        ...
        waitbar(1,hf,'Extracting lung regions ...');
        cc = bwconncomp(lmask);
