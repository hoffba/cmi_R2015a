%
function [MF,labels] = minkowskiFun(img,thresh,tmode,varargin)
...
if gchk % Perform global analysis
    ...
    if pp.prog, hw = waitbar(0,'Processing Minkowski Functional Analysis ...'); end
    for ith = 1:nth
