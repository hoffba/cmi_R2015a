...
function outParams = fw_i2cm1i_3pluspoint_hernando_graphcut_BH( imDataParams, algoParams )
...
% Get data dimensions
[sx,sy,sz,C,N,nka] = size(imDataParams.images);
