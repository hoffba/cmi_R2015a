...
if exist('org.apache.poi.ss.usermodel.WorkbookFactory', 'class') ~= 8 ...
    ...
    tpath = which('cmi'); tpath = fullfile(fileparts(tpath),'poi_library',...
                                    {'poi-3.8-20120326.jar',...
                                     'poi-ooxml-3.8-20120326.jar',...
                                     'poi-ooxml-schemas-3.8-20120326.jar',...
                                     'xmlbeans-2.3.0.jar',...
                                     'dom4j-1.6.1.jar'});
    if all(cellfun(@(x)exist(x,'file'),tpath))
...
if xlsFile.isFile()
    ...
    switch lower(fileExt)
        case '.xls'
            xlsWorkbook = org.apache.poi.hssf.usermodel.HSSFWorkbook();
        case '.xlsx'
            xlsWorkbook = org.apache.poi.xssf.usermodel.XSSFWorkbook();
        otherwise
            xlsWorkbook = org.apache.poi.xssf.usermodel.XSSFWorkbook();
