...
h.tab_Opts = uitab(h.tabGrp,'Title','Options','Tag','tab_Opts');
    ...
    h.text_clampHom = uicontrol(h.tab_Opts,'Style','text','Tag','text_clampHom',...
        'String','Homologous Image Limits: ','Position',[0.01,0.83,0.35,0.04],...
        'HorizontalAlignment','right');
    h.edit_clampHom = uicontrol(h.tab_Opts,'Style','edit','Tag','edit_clampHom',...
        'Position',[0.36,0.835,0.35,0.04],'String','-inf   inf','Callback',@self.UDpreproc);
    h.text_clampRef = uicontrol(h.tab_Opts,'Style','text','Tag','text_clampRef',...
        'String','Reference Image Limits: ','Position',[0.01,0.785,0.35,0.04],...
        'HorizontalAlignment','right');
    h.edit_clampRef = uicontrol(h.tab_Opts,'Style','edit','Tag','edit_clampRef',...
        'Position',[0.36,0.79,0.35,0.04],'String','-inf   inf','Callback',@self.UDpreproc);
    
    h.text_preFilter = uicontrol(h.tab_Opts,'Style','text','Tag','text_preFilter',...
        'HorizontalAlignment','right','String','Pre-Filter: ','Position',[0.01,0.72,0.12,0.04]);
    h.popup_filterType = uicontrol(h.tab_Opts,'Style','popupmenu','Tag','popup_filterType',...
        'Position',[0.13,0.725,0.22,0.04],'Callback',@self.UDpreproc,...
        'String',{'Gaussian','Median','Wiener'});
    h.edit_preFilter = uicontrol(h.tab_Opts,'Style','edit','Tag','edit_preFilter',...
        'Position',[0.37,0.73,0.35,0.04],'String','0 0 0','Callback',@self.UDpreproc);
    
    h.text_VOIdilate = uicontrol(h.tab_Opts,'Style','text','Tag','text_VOIdilate',...
        'String','VOI Dilate: ','Position',[0.01,0.67,0.14,0.04]);
    h.edit_VOIdilate = uicontrol(h.tab_Opts,'Style','edit','Tag','edit_VOIdilate',...
        'Position',[0.15,0.675,0.35,0.04],'String','0 0 0','Callback',@self.UDpreproc);
    
    h.text_Qfile = uicontrol(h.tab_Opts,'Style','text','Tag','text_Qfile',...
        'String','Queue File: ','Position',[0.01,0.09,0.2,0.04]);
    h.button_Qfile = uicontrol(h.tab_Opts,'Style','pushbutton','Tag','button_Qfile',...
        'String','Browse','Position',[0.01,0.06,0.19,0.045],'Callback',@self.setQfile);
    h.edit_Qfile = uicontrol(h.tab_Opts,'Style','edit','Tag','edit_Qfile','Max',2,...
        'String',self.qfile,'FontSize',10,'Position',[0.22,0.05,0.77,0.09],...
...
h.tab_T0 = uitab(h.tabGrp,'Title','Initial Transform','Tag','tab_T0');
    ...
    h.edit_a22 = uicontrol(h.tab_T0,'Style','edit','Tag','edit_a22',...
        'Position',[0.27,0.15,0.2,0.05],'String','1','Callback',@self.setT,...
        'Enable','off');
    h.edit_a23 = uicontrol(h.tab_T0,'Style','edit','Tag','edit_a23',...
        'Position',[0.49,0.15,0.2,0.05],'String','0','Callback',@self.setT,...
        'Enable','off');
    h.edit_a31 = uicontrol(h.tab_T0,'Style','edit','Tag','edit_a31',...
        'Position',[0.05,0.09,0.2,0.05],'String','0','Callback',@self.setT,...
        'Enable','off');
    h.edit_a32 = uicontrol(h.tab_T0,'Style','edit','Tag','edit_a32',...
        'Position',[0.27,0.09,0.2,0.05],'String','0','Callback',@self.setT,...
        'Enable','off');
    h.edit_a33 = uicontrol(h.tab_T0,'Style','edit','Tag','edit_a33',...
        'Position',[0.49,0.09,0.2,0.05],'String','1','Callback',@self.setT,...
        'Enable','off');
    ...
    h.edit_t3 = uicontrol(h.tab_T0,'Style','edit','Tag','edit_t3',...
        'Position',[0.71,0.09,0.2,0.05],'String','0','Callback',@self.setT,...
        'Enable','off');
...
h.tab_Elx = uitab(h.tabGrp,'Title','Elastix','Tag','tab_Elx');
    ...
    h.checkbox_jac = uicontrol(h.tab_Elx,'Style','checkbox','Tag','checkbox_jac',...
        'Position',[0.55,0.71,0.4,0.04],'String','| Jacobian |','Callback',@self.UDschedule);
    h.checkbox_jacmat = uicontrol(h.tab_Elx,'Style','checkbox','Tag','checkbox_jacmat',...
        'Position',[0.55,0.67,0.4,0.04],'String','Jacobian Matrix','Callback',@self.UDschedule);
    h.checkbox_def = uicontrol(h.tab_Elx,'Style','checkbox','Tag','checkbox_def',...
        'Position',[0.55,0.63,0.4,0.04],'String','Deformation Fields','Callback',@self.UDschedule);
    h.checkbox_saveIntermediates = uicontrol(h.tab_Elx,'Style','checkbox',...
        'Tag','checkbox_saveIntermediates','Position',[0.55,0.59,0.4,0.04],...
