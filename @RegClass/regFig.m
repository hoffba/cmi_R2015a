...
h.tab_Opts = uitab(h.tabGrp,'Title','Options','Tag','tab_Opts');
    ...
    h.edit_preFilter = uicontrol(h.tab_Opts,'Style','edit','Tag','edit_preFilter',...
        'Position',[0.37,0.73,0.35,0.04],'String','3 3','Callback',@self.UDpreproc);
