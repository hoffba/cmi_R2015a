function varargout = multiTform(varargin)
% MULTITFORM MATLAB code for multiTform.fig
%      MULTITFORM, by itself, creates a new MULTITFORM or raises the existing
%      singleton*.
%
%      H = MULTITFORM returns the handle to a new MULTITFORM or the handle to
%      the existing singleton*.
%
%      MULTITFORM('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in MULTITFORM.M with the given input arguments.
%
%      MULTITFORM('Property','Value',...) creates a new MULTITFORM or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before multiTform_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to multiTform_OpeningFcn via varargin.
%
...
gui_State = struct('gui_Name',       mfilename, ...
                   ...
                   'gui_OpeningFcn', @multiTform_OpeningFcn, ...
                   'gui_OutputFcn',  @multiTform_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
